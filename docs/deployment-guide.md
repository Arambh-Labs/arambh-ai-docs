...
### Option 2: VM-Based Deployment in the Customer's Network
Arambh AI is deployed as a virtual machine within your own network infrastructure. All data-at-rest resides with the customer. The system connects to Arambh AI models hosted in Microsoft Foundry in nearest supported Azure region via stateless API calls. No data from API calls is stored.

![Arambh AI Deployment Architecture]({{ site.baseurl }}/assets/images/deployment-customernetwork.png)
...
**Requirements:**
- Provision VM according to system requirements given below
...
In both the hosting options mentioned above, Arambh AI uses models through Microsoft's AI Foundry service.
You may opt to use models from Arambh AI cloud, or from your own Azure subscription.

Microsoft Foundry provides the following data protection guarantees:
...
**Microsoft Foundry** is a fully managed Azure service, hosted by Microsoft, ensuring enterprise-grade security and compliance.
